package com.pzxbc.apkinstaller;
  ...
  public void install(String filePath, Promise promise) {
    ...
    try {
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
        ...
        String authority = reactContext.getPackageName() + ".apkinstaller_fileprovider";
        apkUri = ApkInstallerFileProvider.getUriForFile(reactContext, authority, apkFile);
      } else {
